...
<body>
    <h1 class="h1">Insert Vendor Data</h1>
    <div class="row">
        <div class="offset-lg-3 col-lg-6">
            <form class="container" method="post" action="vendorsubmit" enctype="multipart/form-data">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input type="submit" class="btn btn-outline-success" />&nbsp;<a href="vendorview"
