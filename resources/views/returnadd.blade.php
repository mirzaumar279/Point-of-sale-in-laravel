...
<body>
    <h1 class="h1">Insert Return Product Data</h1>
    <div class="row">
        <div class="offset-lg-3 col-lg-6">
            @if ($errors->any())
                ...
                @endforeach
            @endif
            <form class="container" method="post" action="returnsubmit" enctype="multipart/form-data">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input id="price" type="number" readonly name="price" required
                                        class="form-control" />
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input type="submit" class="btn btn-outline-success" />&nbsp; <a href="returnview"
