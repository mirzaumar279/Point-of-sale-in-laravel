        ...
        <tbody>
            ...
            @foreach ($vendorArr as $vendor)
                <tr>
                    ...
                    <td>
                        <a href="vendoredit/{{ $vendor->id }}" class="btn btn-outline-success"><i
                                class="fa fa-pen"></i></a>
                        &nbsp;
                        <a href="vendordelete/{{ $vendor->id }}" class="btn btn-outline-danger"><i
                                class="fa fa-trash"></i></a>
                        &nbsp;
                        <a href="vendordetail/{{ $vendor->id }}" class="btn btn-outline-primary"><i
                                class="fa fa-eye"></i></a>
                    </td>
                </tr>
            @endforeach
            <tr>
                <td class="kk" colspan="9"><a href="vendoradd">Add Vendor</a></td>
            </tr>
        </tbody>
    </table>
