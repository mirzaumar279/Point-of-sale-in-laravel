...
<body>
    ...
    <div class="mm">----------------------------------------------------</div>
    <br>
    <h2 class="mm">Return Transaction Details</h2>
    <h5 class="mm">Total Amount : <b>{{ $returntransactionArr->rtamount }}</b></h5>
    <h5 class="mm">Customer Paid : <b>{{ $returntransactionArr->rtpaid }}</b></h5>
    <h5 class="mm">Return Balance : <b>{{ $returntransactionArr->rtbalance }}</b></h5>
    <h5 class="mm">Payment Method : <b>{{ $returntransactionArr->rmethod }}</b></h5>
    <h5 class="mm">Payment Date: <b>{{ date('d/m/Y', strtotime($returntransactionArr->created_at)) }}</b></h5>
    </div>
    </div>
    </div>
    </div>
