            ...
            <table id="customers" style="margin-top: 20px">
                ...
                <tbody>
                    ...
                    @foreach ($transaction->history as $history)
                        <tr>
                            <td>{{ $history->id }}</td>
                            <td>{{ $history->hproduct }}</td>
                            <td>{{ $history->hquantity }}</td>
                            <td>{{ $history->hprice }}</td>
                            <td>{{ $history->hquantity * $history->hprice }}
                            </td>
                            ...
                            <td>{{ date('h : i A', strtotime($history->created_at)) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
